...
<div>
    ...
    <form action="server.php" method="POST">
        ...
        <input type="number" id="management" name="management" required><br><br>
        
        <label for="accounting">Accounting:</label>
        <input type="number" id="accounting" name="accounting" required><br><br>
        
        <label for="cpp">C++:</label>
        <input type="number" id="cpp" name="cpp" required><br><br>
        ...
        <button type="submit" name="saveMarks">Save</button>
    </form>
</body>
</html>